                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              Text(activityProvider.completedProject.toString(),
                                style: GoogleFonts.poppins(fontSize: 27)),
                              Text(' Completed',
                                style: GoogleFonts.poppins(fontSize: 14)),
                            ],
                      ...
                      Image.asset('assets/project.png', width: 100, fit: BoxFit.cover)
                    ],
                  ),
                ),
              ),
              ...
              Card(
                ...
                child: Padding(
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Image.asset('assets/speech.png', width: 100, fit: BoxFit.cover),
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text("Speeches Given",
                          ...
                          Row(
                            children: [
                              Text(activityProvider.completedSpeeches.toString(),
                                style: GoogleFonts.poppins(fontSize: 27)),
                              Text(' Completed',
                                style: GoogleFonts.poppins(fontSize: 14)),
                            ],
                ...
                child: Padding(
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Image.asset('assets/community.png', width: 100, fit: BoxFit.cover)
                    ],
                  ),
                ),
              ),
